...
/**
 * @brief Multiply transformation by a user-specified factor.
 *
 * @param [in] T Affine transformation matrix.
 *
 * @returns Multiplied affine transformation.
 */
Image::Transform MultiplyTransform(const Image::Transform& T, float factor);

/**
 * @brief Multiply deformation field by a user-specified factor.
 *
 * @param [in] D           Deformation field in DRAMMS format.
 * @param [in] factor      Multiplication factor.me is increased.
 *
 * @returns Multiplied deformation field.
 *
 */
Image* MultiplyTransform(const Image* D, float factor);

/**
 * @brief Divide transformation by a user-specified factor.
 *
 * @param [in] T Affine transformation matrix.
 *
 * @returns Divided affine transformation.
 */
 ...
 *
 * @param [in] D           Deformation field in DRAMMS format.
 * @param [in] factor      Division factor.me is increased.
 *
 * @returns Divided deformation field.
 *
 */
...
/**
 * @brief Estimate inverse deformation field by Chen et al, Medical Physics, 2008.
 *
 * This function estimates the inverse deformation field of a two-dimensional
 * or three-dimensional deformation field based on Chen et al, "A simple fixed
 * -point approach to invert a deformation field,” Med. Phys., vol.35, no. 1, 
 * pp. 81–88, 2008. Implemented on 1/13/2014.
 *
 * @param [in] D           Deformation field in DRAMMS format.
 *
 * @returns Inverse deformation field.
